...
// `active` → the waves pulse (currently speaking).
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
      ...
      {muted ? (
        ...
        <>
          <path d="M15.5 8.5a5 5 0 0 1 0 7" className={active ? 'origin-center animate-pulse' : ''} />
          <path d="M18.5 5.5a9 9 0 0 1 0 13" className={active ? 'origin-center animate-pulse' : ''} />
        </>
      )}
    </svg>
  )
...
export function HeadsetIcon({ className = '' }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
      ...
      {/* little mic boom — reads as a headset/voice control rather than plain headphones */}
